...
public enum ConsumableItemType {
    ENERGY_STEAK(Material.COOKED_BEEF, "能量牛排", false, 100, 165),
    HEALING_APPLE(Material.APPLE, "治愈苹果", false, 100, 100),
    ULTIMATE_HEALING_APPLE(Material.APPLE, "增强治愈苹果", true, 200, 300),
    SPEED_SOUP(Material.RABBIT_STEW, "速度汤", false, 200, 185),
    ...
    LEATHER_ARMOR(Material.LEATHER_HELMET, "皮革盔甲套装", false, 0, new Tuple<>(Sound.ITEM_ARMOR_EQUIP_LEATHER, 1.0F), 200),
    IRON_ARMOR(Material.IRON_HELMET, "铁盔甲套装", false, 0, new Tuple<>(Sound.ITEM_ARMOR_EQUIP_IRON, 1.0F), 800),
    DIAMOND_ARMOR(Material.DIAMOND_HELMET, "钻石盔甲套装", false, 0, new Tuple<>(Sound.ITEM_ARMOR_EQUIP_DIAMOND, 1.0F), 1200);
