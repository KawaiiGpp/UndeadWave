...
public enum ConsumableItemType {
    ENERGY_STEAK(Material.COOKED_BEEF, "能量牛排", false, 200, 200),
    HEALING_APPLE(Material.APPLE, "治愈苹果", false, 200, 100),
    ULTIMATE_HEALING_APPLE(Material.APPLE, "增强治愈苹果", true, 400, 550),
    SPEED_SOUP(Material.RABBIT_STEW, "速度汤", false, 1000, 240),

    FROZEN_FEATHER(Material.FEATHER, "冰冻羽毛", true, 200, new Tuple<>(Sound.BLOCK_GRASS_PLACE, 0.5F), 650),
    FROZEN_MUSHROOM(Material.BROWN_MUSHROOM, "寒冰蘑菇", true, 400, new Tuple<>(Sound.BLOCK_GLASS_BREAK, 0.5F), 650),

    LEATHER_ARMOR(Material.LEATHER_HELMET, "皮革盔甲套装", false, 0, new Tuple<>(Sound.ITEM_ARMOR_EQUIP_LEATHER, 1.0F), 300),
